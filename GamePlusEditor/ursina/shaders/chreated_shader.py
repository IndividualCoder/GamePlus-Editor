...
if __name__ == '__main__':
    ...
    program = load_program(vertex_shader='vertex.glsl', fragment_shader='fragment.glsl')
    Entity(model='cube', color=color.red, shader=colored_lights_shader)
    e = Entity(model='cube', x=1.2, shader=colored_lights_shader, color=color.red)
